            ...
            connect(coin,&MyCoin::clicked,[=](){
                ...
                QTimer::singleShot(300,this,[=](){
                    ...
                    for(int i=0;i<4;i++)
                    {
                        for(int j=0;j<4;j++)
                        {
                            if(coinBtn[i][j]->flag==false)//只要有一个是反面，那就算是失败
                            {
                                this->isWin=false;
                                break;
                            }
